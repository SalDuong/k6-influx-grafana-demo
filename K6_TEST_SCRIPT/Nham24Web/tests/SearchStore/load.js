...
export let options = {
    stages: [
      { duration: "10m", target: 50 }, // Ramp up to 50 users over 1 minute
      { duration: "20m", target: 50 }, // Stay at 50 users for 3 minutes
...
export default function main() {
  ...
  group(
    'page_4 - https://nham24-com-git-dev-go24.vercel.app/food?s_type=store&search=coffee',
    function () {
      response = http.get(
        'https://godev.nham24.com/api/v1/customer/store/1?serviceId=1&sort=distance&filter[name]=coffee&latitude=11.569577&longitude=104.9206905',
        {
          headers: {
...
export function handleSummary(data) {
    return {
      "./tests/k6/Report/load/Nham24WebSearchStoreLoadTesting.html":
        htmlReport(data),
    };
  }
